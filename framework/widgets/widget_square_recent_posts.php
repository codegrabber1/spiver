 ...
 */
 ...
 =================== */
 add_action( 'widgets_init', 'spiver_srp_widgets' );
 function spiver_srp_widgets(){
  register_widget( 'spiver_srp_widget' );
}
...
=================== */
class spiver_srp_widget extends WP_Widget{
  /* ===================
	 * Widget setup.
  =================== */
  function __construct(){
     ...
     parent::__construct( 'spiver_srp_widget', __( 'Spiver: Square Pic', 'Spiver' ), $widget_ops );
   }
   /* ===================
   ...
   public function form( $instance ) {
    ...
    ?>
    <p><label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title:', 'Spiver'); ?></label>
     ...
     <p><label for="<?php echo $this->get_field_id( 'entries_display' ); ?>"><?php _e('How many entries to display?', 'Spiver'); ?></label>
      ...
      <p><label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php _e( 'Filter by Category:', 'Spiver' ); ?></label>
