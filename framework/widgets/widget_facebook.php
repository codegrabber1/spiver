...
add_action( 'widgets_init', 'makecodework_facebook_widgets' );
function makecodework_facebook_widgets() {
	register_widget( 'makecodework_facebook_widget' );
}

class makecodework_facebook_widget extends WP_Widget {
	/**
	 * Widget setup.
	 */
	function __construct() {
		...
		parent::__construct('makecodework_facebook_widget', 'Spiver: Facebook Likebox', $widget_ops);
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title:', 'makecodework'); ?></label>
			<input type="text" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo $instance['title']; ?>" style="width:100%;" />
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('page_url'); ?>"><?php _e('Facebook Page URL:', 'makecodework') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('width'); ?>"><?php _e('Width:', 'makecodework') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('tabs'); ?>"><?php _e('News line:', 'makecodework') ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_faces'); ?>"><?php _e('Show faces', 'makecodework') ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('hide_cover'); ?>"><?php _e('Hide cover', 'makecodework') ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_header'); ?>"><?php _e('Show small facebook header', 'makecodework') ?></label>
		</p>
